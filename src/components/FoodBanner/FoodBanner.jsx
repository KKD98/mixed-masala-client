...
const FoodBanner = () => {
    return (
        ...
        <img src={foodimage} alt="cover" className='lg:h-screen w-full'/>
        ...
        <div className="mt-8 lg:mt-0 slider-text absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
            <p className='text-xl lg:text-3xl font-bold w-full'>Subscribe to our Newsletter</p>
            <p  className='my-2 lg:mt-4 lg:mb-6 font-bold text-xl lg:text-xl w-full'>"Delight your taste buds with our mouthwatering recipes!"</p>
